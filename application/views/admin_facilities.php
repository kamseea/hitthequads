...
<table class="table">
  <thead>
    <tr>
      <th scope="col">ID</th>
      <th scope="col">Name of Organization/Individual</th>
      ...
      <th scope="col">Purpose of Reservation</th>
  ...
  <tbody>
    ...
    <tr>
        ...
        <td><?php echo urldecode($item[$i] -> type);?></td>
        ...
        <td><button type="button" class="delete-btn"><a href= "<?php echo 'http://localhost/quads/index.php/napwc/delete_facilities/' . $item[$i] -> id; ?>" class="delete-txt"> Delete </img> </a></td>
